...
export default function Home() {
  ...
  const contractAddress = "0x34796ef8ccd74392533ab9fd5cafae33a56142a1";
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy baobao a Coffee!</title>
        <meta name="description" content="Tipping site" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>Buy baobao a Coffee!</h1>
        ...
        {currentAccount ? (
          <div>
            <form>
              ...
              <br />
              <div class="formgroup">
                <label>Send baobao a message</label>
                <br />
